...
import MerrisN4.Block0Base
import MerrisN4.Block0.Slice7Data
...
namespace MerrisN4.Block0.Slice7
...
def mappings : List (List Nat) :=
  (cellMappings.drop 1008).take 144
...
theorem eval_target_nonneg (x : Fin 9 → ℝ)
  ...
  exact eval_orbitCertificate_nonneg x entriesNonnegative
    mappings seedCells squares Block0Base.weights_nonnegative

end MerrisN4.Block0.Slice7
